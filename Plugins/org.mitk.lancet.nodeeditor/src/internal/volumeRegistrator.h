#ifndef VOLUMEREGISTRATOR_H
#define VOLUMEREGISTRATOR_H
#include "mitkImage.h"
#include "mitkImageToImageFilter.h"



class VolumeRegistrator : public itk::Object
{
public:
	mitkClassMacroItkParent(VolumeRegistrator, itk::Object);
	itkNewMacro(Self);
