...
public:
  ...
  std::vector<MarkerData> getMarkerData(unsigned short handle);
  std::vector<double> getTransform(unsigned short handle);
  ...
  void getReferenceMatrix4x4Marker(double d[16], vtkMatrix4x4 *matrix);
