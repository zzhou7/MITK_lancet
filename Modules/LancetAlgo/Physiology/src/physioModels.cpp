...
namespace lancetAlgorithm
{
	...
	void AIAngleRadiographic(double *direction, double &ResultAnteversion, double &ResultInclination)
	{
		...
		ResultAnteversion = (double)(VersionRadians * (180.0f / M_PI)) - D_value;
		...
		ResultInclination = (double)(InclinationRadians * (180.0f / M_PI));
	...
	void AIAngleOperative(double *direction, double &ResultAnteversion, double &ResultInclination)
	{
		...
		ResultAnteversion = (double)(VersionRadians * (180.0f / M_PI));
		...
		ResultInclination = (double)(InclinationRadians * (180.0f / M_PI)) - D_value;
