...
mitk::ClosedContourTool::ClosedContourTool(bool snapToContour)
  : FeedbackContourTool("LiveWireTool"), m_SnapToContour(snapToContour), m_CreateAndUseDynamicCosts(false)
{
}

mitk::ClosedContourTool::~ClosedContourTool()
{
}

void mitk::ClosedContourTool::RemoveHelperObjects()
{
...
void mitk::ClosedContourTool::ReleaseHelperObjects()
{
...
void mitk::ClosedContourTool::ConnectActionsAndFunctions()
{
...
void mitk::ClosedContourTool::Activated()
{
...
void mitk::ClosedContourTool::Deactivated()
{
  this->ConfirmSegmentation();
  Superclass::Deactivated();
}

void mitk::ClosedContourTool::UpdateLiveWireContour()
{
...
void mitk::ClosedContourTool::OnTimePointChanged()
{
...
void mitk::ClosedContourTool::EnableContourLiveWireInteraction(bool on)
{
  for (const auto &interactor : m_LiveWireInteractors)
    interactor->EnableInteraction(on);
}

void mitk::ClosedContourTool::ConfirmSegmentation()
{
...
void mitk::ClosedContourTool::ClearSegmentation()
{
...
bool mitk::ClosedContourTool::IsPositionEventInsideImageRegion(mitk::InteractionPositionEvent *positionEvent,
                                                            mitk::BaseData *data)
{
  ...
  if (!isPositionEventInsideImageRegion)
    MITK_WARN("ClosedContourTool") << "PositionEvent is outside ImageRegion!";

  return isPositionEventInsideImageRegion;
}

mitk::ContourModel::Pointer mitk::ClosedContourTool::CreateNewContour() const
{
...
void mitk::ClosedContourTool::OnInitLiveWire(StateMachineAction *, InteractionEvent *interactionEvent)
{
  ...
  m_LiveWireFilter->SetUseCostFunction(m_SnapToContour);
  m_LiveWireFilter->SetInput(m_ReferenceDataSlice);
  ...
  AccessFixedDimensionByItk_2(
    m_ReferenceDataSlice, FindHighestGradientMagnitudeByITK, 2, idx, indexWithHighestGradient);
...
void mitk::ClosedContourTool::OnAddPoint(StateMachineAction *, InteractionEvent *interactionEvent)
{
  ...
  std::for_each(
    m_LiveWireContour->IteratorBegin(), m_LiveWireContour->IteratorEnd(), [this](ContourElement::VertexType *vertex) {
...
void mitk::ClosedContourTool::OnMouseMoveNoDynamicCosts(StateMachineAction *, InteractionEvent *interactionEvent)
{
...
bool mitk::ClosedContourTool::OnCheckPoint(const InteractionEvent *interactionEvent)
{
...
void mitk::ClosedContourTool::OnFinish(StateMachineAction *, InteractionEvent *interactionEvent)
{
  ...
  this->m_WorkingContours.emplace_back(
    std::make_pair(m_ContourNode, positionEvent->GetSender()->GetCurrentWorldPlaneGeometry()->Clone()));
  this->m_EditingContours.emplace_back(
    std::make_pair(m_EditingContourNode, positionEvent->GetSender()->GetCurrentWorldPlaneGeometry()->Clone()));
...
void mitk::ClosedContourTool::FinishTool()
{
  ...
  m_ContourInteractor->SetUseCostFunction(m_SnapToContour);
...
void mitk::ClosedContourTool::OnLastSegmentDelete(StateMachineAction *, InteractionEvent *interactionEvent)
{
...
void mitk::ClosedContourTool::FindHighestGradientMagnitudeByITK(itk::Image<TPixel, VImageDimension> *inputImage,
                                                             itk::Index<3> &index,
