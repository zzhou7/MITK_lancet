...
#include "mitkImage.h"
#include "MitkDRRSIDONJACOBSRAYTRACINGExports.h"
#include "mitkImageToImageFilter.h"

// mitk::Image::Pointer MITKDRRSIDONJACOBSRAYTRACING_EXPORT DRRSIDONJACOBSRAYTRACING(mitk::Image::Pointer input);

class MITKDRRSIDONJACOBSRAYTRACING_EXPORT DRRSidonJacobsRayTracingFilter:public mitk::ImageToImageFilter
{
public:
	mitkClassMacro(DRRSidonJacobsRayTracingFilter, ImageToImageFilter);
...
protected:
	...
	*/
  // MODIFIED
	DRRSidonJacobsRayTracingFilter();
	/*!
	\brief standard destructor
	*/
  // MODIFIED
	~DRRSidonJacobsRayTracingFilter() override;
	/*!
