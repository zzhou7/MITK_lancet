#ifndef modifiedItkSiddonJacobsRayCastInterpolateImageFunction_hxx
#define modifiedItkSiddonJacobsRayCastInterpolateImageFunction_hxx
...
namespace itk
{
  ...
  ModifiedSiddonJacobsRayCastInterpolateImageFunction<TInputImage,
                                                      TCoordRep>::ModifiedSiddonJacobsRayCastInterpolateImageFunction()
  {
  ...
  template <typename TInputImage, typename TCoordRep>
  void ModifiedSiddonJacobsRayCastInterpolateImageFunction<TInputImage, TCoordRep>::PrintSelf(std::ostream &os,
                                                                                      Indent indent) const
  {
  ...
  template <typename TInputImage, typename TCoordRep>
  typename ModifiedSiddonJacobsRayCastInterpolateImageFunction<TInputImage, TCoordRep>::OutputType
    ModifiedSiddonJacobsRayCastInterpolateImageFunction<TInputImage, TCoordRep>::Evaluate(const PointType &point) const
  {
    float rayVector[3];
    IndexType cIndex;
  ...
  template <typename TInputImage, typename TCoordRep>
  typename ModifiedSiddonJacobsRayCastInterpolateImageFunction<TInputImage, TCoordRep>::OutputType
    ModifiedSiddonJacobsRayCastInterpolateImageFunction<TInputImage, TCoordRep>::EvaluateAtContinuousIndex(
  ...
  template <typename TInputImage, typename TCoordRep>
  void ModifiedSiddonJacobsRayCastInterpolateImageFunction<TInputImage, TCoordRep>::Initialize()
  {
    this->ComputeInverseTransform();
    m_SourceWorld = m_InverseTransform->TransformPoint(m_SourcePoint);
  }
